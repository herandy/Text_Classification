...
def CNN_model(N_HIDDEN=24):
    ...
    gru = Bidirectional(CuDNNGRU(N_HIDDEN, return_sequences=False, kernel_regularizer=regularizers.l2(REGVAL)))(drop)
    lstm_dense = Dense(NCLASS, activation='softmax', kernel_regularizer=regularizers.l2(REGVAL), name='lstm_dense')(gru)
